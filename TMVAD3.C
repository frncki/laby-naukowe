...
int TMVAD3( TString myMethodList = "" )
{
  ...
  // std::cout << "--- TMVAClassification       : Using input file: " << input->GetName() << std::endl;
   ...
   TTree *signalTree     = (TTree*)input2->Get("ntpD0");
   TTree *background     = (TTree*)input1->Get("ntpD0BackgroundSameSignPt01");
...
//   dataloader->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
   ...
   TCut mycuts = "pt>0 && pt<1"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
